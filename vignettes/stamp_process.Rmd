...
```{r my_nb_idx}
my_nb <- nb_from_tags(perl_tags, metadata_column = "MyNb")

qiime_nb <- nb_from_tags(qiime_tags, zero_filter = FALSE, metadata_column="qiimenb")
```
...
topn600_nb <- nb_from_tags(topn_filtered, zero_filter = FALSE, metadata_column = "Nb600")
top500_filtered <- filter_topn_tags(topn600_nb, topn = 500)
topn500_nb <- nb_from_tags(top500_filtered, zero_filter = FALSE, metadata_column = "Nb500",
